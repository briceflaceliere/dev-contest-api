...
class GenerateControllerCommand extends ContainerAwareCommand
{
        ...
        if ($entityManager->getClassMetadata($entity)) {
    		...
    		foreach ($filesToCreate as $file => $options) {
		        ...
		        if ($helper->ask($input, $output, $question)) {
                    ...
                    $this->_replaceEntityInTemplates($filePath, $entityName, $plural, $bundleName);
    ...
    protected function _replaceEntityInTemplates($filePath, $entityName, $plural, $bundleName)
    {
